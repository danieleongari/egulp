...
void  psinv_small_row_large_column(double *mat, int n_fil, int n_col, double *psinv_matrix, int ldebug); 
void  psinv_large_row_small_column(double *mat, int n_fil, int n_col, double *psinv_matrix, int ldebug); 


void  psinvmat(double *mat, int n_fil, int n_col, double *psinv_matrix, int ldebug)
{
         if(n_fil <  n_col) { 
...
void  psinv_small_row_large_column(double *mat, int n_fil, int n_col, double *psinv_matrix, int ldebug) 
{
	...
	for (i = 0; i < n_fil; i++)
		for (j = 0; j < n_col; j++)  
	   		gsl_matrix_set (gA, i, j, mat[i*n_col+j] );
